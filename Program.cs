namespace CurrencyRatesLoader
{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            for (; ; ) // Проверяет начало нового дня каждую минуту и если он наступил отправляет запрос. Лучше было бы определить, что данные обновились на новый день и в этом момент выгружать.
            {
